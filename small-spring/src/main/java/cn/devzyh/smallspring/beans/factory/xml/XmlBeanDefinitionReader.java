...
import cn.devzyh.smallspring.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public void loadBeanDefinitions(Resource resource) throws BeansException {
        try {
            ...
            throw new BeansException("解析XML配置发生异常" + resource, e);
        }
    }
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        if (componentScan != null) {
            ...
            if (StrUtil.isEmpty(scanPath)) {
                throw new BeansException("base-package属性值不能为空");
            }
        ...
        for (Element bean : beanList) {
            ...
            if (getRegistry().containsBeanDefinition(beanName)) {
                throw new BeansException("出现重复的bean名称[" + beanName + "]");
            }
            // 注册 BeanDefinition
